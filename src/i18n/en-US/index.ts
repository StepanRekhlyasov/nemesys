...
export default {
  ...
  client: {
    ...
    add: {
      ...
      officeCommonInformation:'Office Information (items common to all types)',
      officeSpecificInformation:'Office information (type-specific items)',
      location: 'Location',
      prefectures: 'Prefectures',
      municipalities: 'Municipalities',
      ...
      parkingLotNotes:'Parking Lot Notes',
  ...
  backOrder: {
    ...
    boSpecificInformation:'BO information (type-specific items)',
    ...
    create: {
      ...
      qualificationRemarks:'Qualification Remarks',
  ...
  job: {
    ...
    jobPostingHistory: 'Job Posting History',
    regionSalarySettings: 'Region/Salary Settings',
    areaSalarySettings: 'Area/Salary Settings',
    formatSettings: 'Format Settings',
    phraseSettings: 'Phrase Settings',
    jobItemSettings: 'Job Item Settings',
    addNewJobBO: 'Click here to add a new job from BO',
    addNewJob: 'Add New Job',
    changeSearchCondition: 'Search condition change',
    changeSearchCriteria: 'Change Search Criteria',
    batchPublishJobAds: 'Batch Publish Job Ads',
    jobID: 'Job ID',
    jobName: 'Job Name',
    createdByBOID: 'Created by BOID',
    office: 'Office',
    client: 'Client',
    ...
    jobReg: 'Job Registration',
    jobUpdate: 'Update job',
    autoJobCreation: 'Automatic Job Creation',
    publish: 'Publish',

    add: {
      basicInfo: 'Basic Information',
      jobName: 'Job Name',
      transactionType: 'Transactiont Type',
      paymentType: 'Payment Type',
      salaryType: 'Salary Type',
      status: 'Status',
      email: 'Email address for application',
      jobContent: 'Job Content',
      appealPoint: 'Appeal Point',
      personnelSought: 'Personnel Sought',
      employmentDay: 'Employment Day',
      numDaysEmployment: 'Num Days Employment',
      workingHoursEarlyShift: 'Working hours (Early shift)',
      workingHoursDayShift: 'Working hours (Day shift)',
      workingHoursLateShift: 'Working hours (Late shift)',
      workingHoursNightShift: 'Working hours (Night shift)',
      employmentContract: 'Employment Contract',
      salaryCap: 'Salary Cap',
      minSalary: 'Minimum Salary',
      treatmentBenefits: 'Treatment/Benefits',
      employmentConditions: 'Employment Conditions',
      experienceRequired: 'Experience Required',
      requiredQualification: 'Required Qualification',
      halfYearExp: 'More than half a year of experience required',
      upperAgeLimit: 'Upper Age Limit',
      mediaInformation: 'Media Information',
      indeedJobCategory: 'Indeed Job Category',
      indeedTag: 'Indeed Tag',
      presenceAbsenceResume: 'Presence or Absence Resume',
      ...
      indeedJobCategoryList: {
        eatingDrinkingFood: 'Eating and drinking, food',
        salesCustomerService: 'Sales, customer service',
        leisureEventEntertainment: 'Leisure/Event/Entertainment',
        sales: 'Sales',
        clericalWorkOfficeWork: 'Clerical work/office work',
        education: 'Education',
        deliveryMovingDriver: 'Delivery/Moving/Driver',
        easyWork: 'Easy work',
        architectureCivilEngineering: 'Architecture/Civil Engineering/Construction',
        factoryManufacturing: 'Factory/Manufacturing',
        itCreative: 'IT/Creative',
        beautyBarberSalon: 'Beauty/barber/salon',
        medicalNursingChildcare: 'Medical care, nursing care, childcare',
        securityCleaningBuilding: 'Security, cleaning, building management',

      },
      indeedTagList: {
        jobTag: 'Job Tag',
        employeePromotions: 'Employee Promotions Available',
        payRaiseAvailable: 'Pay Raise Available',
        noOvertime: 'No overtime',
        ok1dayWeek: '1 day per week',
        ok23DayWeek: '2 to 3 days per week',
        freeShift: 'Free shift',
        paidTransportationExpenses: 'Transportation Fee paid',
        sameDayWorkOK: 'Immediate work OK',
        urgentNeeded: 'Urgently needed',
        within5minutesStation: 'Within 5 minutes from station',
        newCoronavirusRelatedTags: 'Tags related to novel coronavirus',
        completelyHome: 'Fully home based',
        okStayHome: 'Home Stay OK',
        flextimeSystem: 'Flextime system available',
        workingHours: 'Skim work',
        staggeredWorkingHours: 'Staggered work hours',
        workStartTimeAdjustment: 'Adjustable start time',
        remoteInterviewOK: 'Remote interviews OK',
        wearMaskWhenInterviewing: 'Wear a mask when interviewing',
      },
      resumeRequiredList: {
        required: 'Required',
  ...
  jobAd: {
    ...
    issuanceJobAd: 'Issue of job ad',
    showPreview: 'Show Preview',
    jobAdAutoCreate: 'Job Ad Auto Create',
    createSpecifyingFormat: 'Create Specifying Format',
    createWithoutFormatting: 'Create without Formatting',

    list: {
      jobAdID: 'JobAd ID',
      jobAdName: 'JobAd Name',
      issuingFormatID: 'Issuing Format ID',
      issuingFormatName: 'Issuing Format Name',
      numApplications: 'Num Applications',
      issuer: 'Issuer',
  ...
  regionSalary: {
    list: {
      areaID: 'Area ID',
      areaName: 'Area Name',
      numPrefectures: 'Num Prefectures',
      numMunicipalities: 'Num Municipalities',
      jobOpenings: 'Job Openings',
      numStaff: 'Num Staff',
      reactionScore: 'Reaction Score',
      updatedBy: 'Updated By',
      updatedDate: 'Updated Date',
      issueNewArea: 'Issue New Area',
      issueNewAreaHint: '※You can create an issuing area by selecting multiple municipalities.',
    },
    add: {
      areaInfo: 'Area Information',
      areaReg: 'Area registration',
  ...
  formatSetting: {
    addNew: 'Add Format Setting',
    mediaName: 'Media Name',
    formatId: 'Format ID',

    add: {
      formatReg: 'Format Registration',
      formatUpdate: 'Format Update',
      formatName: 'Format Name',
      formatInfo: 'Format Information',
      formatDesc: 'Format description',
      formatting: 'Format settings',
      companyName: 'Company Name',
      jobcatchCopy: 'Job Catch Copy',
      jobCategory:  'Job Category',
      workLocation: 'Work Location',
      minSalary: 'Salary (Min)',
      workingHours: 'Working hours/Days of the week',
      leaveHolidays: 'Leaves/Holidays',
      access: 'Access',
      postingImage: 'Posting Image',
      tag: 'Tag',
      infoApplicants: 'Information about applicants',
      phone: 'Phone number (single-byte)',
      judgingQuestions: 'Judging Questions',
      jobId: 'Job ID (not editable)',

    }
  },
  phraseSettings: {
    phraseID: 'Phrase ID',
    addNew: 'Add New Phrase',
    phraseName: 'Phrase Name',
    numUsers: 'Num Users',

    add: {
      phraseReg: 'Phrase registration',
      phraseUpdate: 'Phrase Update',
      phraseName: 'Phrase name',
      phraseContent: 'Phrase content',
      phraseInfo: 'Phrase information',
      phraseCategory: 'Phrase category',
      phraseDesc: 'Phrase description',
      recruitmentItemRefer: 'Recruitment item to refer to',
      recruitmentItemName: 'Recruitment item name',
      dataType: 'Data type',
      choice: 'Choice',
      ...
      jobItem: {
      jobItemID: 'Job Item ID',
      category: 'Category',
      addNew:'Add New Job item',
      add: {
      jobItemReg: 'Job Item Registration',
      jobItemUpdate: 'Job Item Update',
      itemInfo: 'Item information',
      itemDesc: 'Item description',
      adItemSettings: 'Advanced item settings',
      optionSetting: 'Option setting',
      optionContent: 'Option content',
      optionContentUpdate: 'Update Option content'
    },
    dataTypeList: {
      option: 'Option',
      number: 'Number',
