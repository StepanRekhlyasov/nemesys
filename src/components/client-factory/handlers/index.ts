...
import { RenderMainInfo, RenderOfficeDetails, RenderHeadDetails } from '../types';
...
export const useOfficeDetails = (clientFactory: ClientFactory, draft: Partial<ClientFactory>): RenderOfficeDetails => {
