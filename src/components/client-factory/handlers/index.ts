...
export const useOfficeDetails = (clientFactory: ClientFactory, draft: Partial<ClientFactory>, industryType?: string): RenderOfficeDetailsWithoutIndustryType | RenderOfficeDetailsWithIndustryType => {
  ...
  if(industryType) {
    officeDetails[`${industryType}.commonItems`] = computed(() => {
      return [
        {label: t('clientFactory.drawer.details.referralFeePer'), value: (safeGet(draft, 'officeDetails.'+industryType+'.referralFeePer') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.referralFeePer')) || '', editType: InputType.COMMA_SEPARATED, key: 'officeDetails.'+industryType+'.referralFeePer', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.referralFeePer') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.referralFeePer') !== safeGet(draft, 'officeDetails.'+industryType+'.referralFeePer')},
        {label: t('clientFactory.drawer.details.salaryHour'), value: (safeGet(draft, 'officeDetails.'+industryType+'.salaryHour') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.salaryHour')) || '', editType: InputType.COMMA_SEPARATED, key: 'officeDetails.'+industryType+'.salaryHour', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.salaryHour') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.salaryHour') !== safeGet(draft, 'officeDetails.'+industryType+'.salaryHour')},
        {label: t('clientFactory.drawer.details.referralFeeFix'), value: (safeGet(draft, 'officeDetails.'+industryType+'.referralFeeFix') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.referralFeeFix')) || '', editType: InputType.COMMA_SEPARATED, key: 'officeDetails.'+industryType+'.referralFeeFix', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.referralFeeFix') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.referralFeeFix') !== safeGet(draft, 'officeDetails.'+industryType+'.referralFeeFix')},
        {label: t('clientFactory.drawer.details.salaryMonth'), value: (safeGet(draft, 'officeDetails.'+industryType+'.salaryMonth') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.salaryMonth')) || '', editType: InputType.COMMA_SEPARATED, key: 'officeDetails.'+industryType+'.salaryMonth', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.salaryMonth') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.salaryMonth') !== safeGet(draft, 'officeDetails.'+industryType+'.salaryMonth')},
        ...
        {label: t('clientFactory.drawer.details.workingHourEarly'), value: (safeGet(draft, 'officeDetails.'+industryType+'.workingHourEarly') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourEarly')) || {}, editType: InputType.HOURS, key: 'officeDetails.'+industryType+'.workingHourEarly', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.workingHourEarly') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourEarly') !== safeGet(draft, 'officeDetails.'+industryType+'.workingHourEarly')},
        ...
        {label: t('clientFactory.drawer.details.workingHourDay'), value: (safeGet(draft, 'officeDetails.'+industryType+'.workingHourDay') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourDay')) || {}, editType: InputType.HOURS, key: 'officeDetails.'+industryType+'.workingHourDay', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.workingHourDay') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourDay') !== safeGet(draft, 'officeDetails.'+industryType+'.workingHourDay')},
        {label: t('clientFactory.drawer.details.canSmoke'), value: `${(safeGet(draft, 'officeDetails.'+industryType+'.canSmoke') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.canSmoke'))|| ''}`, editType: 'radio', key: 'officeDetails.'+industryType+'.canSmoke', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.canSmoke') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.canSmoke') !== safeGet(draft, 'officeDetails.'+industryType+'.canSmoke'), radioVals: [{label: t('applicant.attendant.possible'), value: '可'}, {label: t('applicant.attendant.no'), value: '不可'}]},
        {label: t('clientFactory.drawer.details.workingHourLate'), value: (safeGet(draft, 'officeDetails.'+industryType+'.workingHourLate') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourLate')) || {}, editType: InputType.HOURS, key: 'officeDetails.'+industryType+'.workingHourLate', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.workingHourLate') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourLate') !== safeGet(draft, 'officeDetails.'+industryType+'.workingHourLate')},
        {label: t('office.commutingByCar'), value: (safeGet(draft, 'officeDetails.'+industryType+'.commutingByCar') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.commutingByCar')) || '', editType: 'radio', key: 'officeDetails.'+industryType+'.commutingByCar', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.commutingByCar') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.commutingByCar') !== safeGet(draft, 'officeDetails.'+industryType+'.commutingByCar'),  radioVals: [{label: t('smoking.yes'), value: '有'}, {label: t('smoking.no'), value: '無'}]},
        {label: t('clientFactory.drawer.details.workingHourNight'), value: (safeGet(draft, 'officeDetails.'+industryType+'.workingHourNight') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourNight')) || {}, editType: InputType.HOURS, key: 'officeDetails.'+industryType+'.workingHourNight', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.workingHourNight') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.workingHourNight') !== safeGet(draft, 'officeDetails.'+industryType+'.workingHourNight')},
