  ...
  if(industryType) {
    ...
    officeDetails.commonItems = computed(() => {
      return [
        ...
        {label: t('office.commutingByCar'), value: (safeGet(draft, 'officeDetails.commonItems.commutingByCar') ?? safeGet(clientFactory, 'officeDetails.commonItems.commutingByCar')) || '', editType: 'radio', key: 'officeDetails.commonItems.commutingByCar', isHighlight: safeGet(draft, 'officeDetails.commonItems.commutingByCar') !== undefined && safeGet(clientFactory, 'officeDetails.commonItems.commutingByCar') !== safeGet(draft, 'officeDetails.commonItems.commutingByCar'), radioVals: [{label: 12, value: '1'}, {label: 22, value: '2'}]},
