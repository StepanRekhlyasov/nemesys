  ...
  if(industryType) {
    officeDetails[`${industryType}.commonItems`] = computed(() => {
      return [
        ...
        {label: t('clientFactory.drawer.details.canSmoke'), value: `${(safeGet(draft, 'officeDetails.'+industryType+'.canSmoke') ?? safeGet(clientFactory, 'officeDetails.'+industryType+'.canSmoke'))|| ''}`, editType: 'text', key: 'officeDetails.'+industryType+'.canSmoke', isHighlight: safeGet(draft, 'officeDetails.'+industryType+'.canSmoke') !== undefined && safeGet(clientFactory, 'officeDetails.'+industryType+'.canSmoke') !== safeGet(draft, 'officeDetails.'+industryType+'.canSmoke')},
