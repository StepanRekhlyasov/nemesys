    ...
    <q-card class="no-shadow full-height q-pb-sm">
      <q-form class="q-gutter-none" @submit="searchClients">
        <q-card-actions v-if="props.from == ''">
          <q-btn :label="$t('client.list.settingFromMap')" unelevated :color="props.theme" class="no-shadow text-weight-bold"
            icon="add" @click="openMapDrawer" />
          <q-btn :label="$t('client.list.settingFromArea')" unelevated :color="props.theme" class="no-shadow text-weight-bold"
        ...
        <q-card-actions v-if="props.from!=='saveCondition'">
          ...
          <q-btn :label="$t('client.list.saveSearchConditions')" outline :color="props.theme" class="text-weight-bold q-ml-md" 
