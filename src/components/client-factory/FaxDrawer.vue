...
const faxData = ref({ setTransmissionDateTime: true, transmissionDateTime: '' });
            ...
            <q-card class="no-shadow bg-grey-3">
                <q-card-section class="text-white bg-primary">
                    <div class="text-h6">
                        ...
                        <q-btn :label="t('clientFactory.fax.transmissionConfirmation')" color="white" text-color="primary"
                            class="text-bold q-ml-lg q-px-md q-py-none" dense />
                    </div>
                </q-card-section>
                <q-separator />
                <q-card-section class="bg-grey-1">
                    <div class="row">
                        ...
                        <span class="text-primary text-bold q-ml-xs">{{ $t('clientFactory.fax.applicantLinkage') }}</span>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-9">
                            <q-select dense outlined emit-value map-options v-model="faxData['applicants']" use-input
                                use-chips multiple input-debounce="0" :options="applicantList" @filter="filterFn" :loading="loading" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3 text-right q-pr-sm text-primary q-pt-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <q-file name="fax_files" v-model="faxData['faxFile']" dense outlined multiple use-chips
