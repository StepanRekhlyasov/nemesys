  ...
  return [
    {
      ...
      name: t('client.add.facilityOp.dayCare'), 
      value: 'dayCare' 
    },{
      ...
      name: t('client.add.facilityOp.shortStay'), 
      value: 'shortStay' 
    },{ 
      name: t('client.add.facilityOp.dayService'), 
      value: 'dayService' 
    },{
      ...
      name: t('client.add.facilityOp.groupHome'), 
      value: 'groupHome' 
    },{
      ...
      name: t('client.add.facilityOp.homeCare'), 
      value: 'homeCare'
    },{
      ...
      name: t('client.add.facilityOp.pharmacy'), 
      value: 'pharmacy' 
    },
  ];
});
