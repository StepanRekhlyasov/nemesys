  ...
  <q-card-section class="bg-white ">
    ...
    <div class="row q-pb-sm">
      ...
      <LabelField :label="$t('backOrder.create.hourlyMonthly')" v-if="selectedBo['type'] == 'referral'"
        :edit="edit" :value="`${$t('backOrder.create.'+selectedBo['wage'])}  ${selectedBo['salary']} ${selectedBo['wage'] == 'monthlySalary' ? $t('backOrder.create.yenMonth')  : $t('backOrder.create.yenHour')}`" valueClass="self-center q-pl-md ">
    ...
    <div class="row q-pb-sm">
      <labelField :label="$t('backOrder.create.requiredQualifications')" :edit="edit" v-if="selectedBo['type'] == 'dispatch'"
        :value="`${selectedBo['requiredQualifications']? $t('common.yes') : $t('common.no')}`">
      ...
      <LabelField :label="$t('backOrder.create.BOGenerationRoute')" :edit="edit" valueClass="self-center q-pl-md col-3" 
      ...
      <labelField :label="$t('backOrder.create.benefit')" :edit="edit" :value="`${data['benefit'] || ''}`" v-if="selectedBo['type'] == 'referral'">
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'">
      ...
      <labelField :label="$t('backOrder.create.bonus')" :edit="edit" :value="`${data['bonus'] || ''}`">
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'"  >
      ...
      <labelField :label="$t('backOrder.create.payday')" :edit="edit" valueClass="col-3 q-pl-md flex"
    ...
    <div class="row q-pb-sm">
      ...
      <labelField :label="$t('backOrder.create.tasks')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" 
        valueClass="q-pl-md col-3" :value="selectedBo['work_content']" v-if="selectedBo['type'] == 'referral'">
        <q-input v-model="data['work_content']" outlined dense :disable="loading"/>
      </labelField>
    </div> 

    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'dispatch'">
      <labelField :label="$t('backOrder.request')" :edit="edit" labelClass="q-pl-md col-3 self-center text-right"
        valueClass="col-3 q-pl-md flex" :value="selectedBo['request']">
        <q-input v-model="data['request']"  outlined dense :disable="loading" hide-bottom-space  />
      </labelField>
      <labelField :label="$t('client.backOrder.upperAgeLimit')" :edit="edit" labelClass="q-pl-md col-3 self-center text-right"
        valueClass="col-3 q-pl-md flex" :value="selectedBo['upperAgeLimit'] + $t('common.ageShort')">
    ...
    <div class="row q-pb-sm"  v-if="selectedBo['type'] == 'dispatch'">
      <labelField :label="$t('backOrder.payment')" :edit="edit" labelClass="q-pl-md col-3 self-center text-right" 
        valueClass="col-3 q-pl-md flex " :value="`${data['payment']}  ${$t('common.yen')}`">
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'">
      <labelField :label="$t('backOrder.employmentType')" :edit="edit" labelClass="q-pl-md col-3 self-center text-right " 
        valueClass="col-3" :value="selectedBo['employmentType']? $t('client.backOrder.'+selectedBo['employmentType']) : ''">
      ...
      <labelField :label="$t('backOrder.create.pickDrop')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" 
        valueClass="q-pl-md col-3 flex" :value="selectedBo['pickDrop']?$t('common.yesShort') : $t('common.noShort')">
        <q-field
          borderless dense
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'">
      <labelField :label="$t('backOrder.create.workingDays')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center"
        valueClass="q-pl-md col-3" :value="selectedBo['workingDays']? $t('backOrder.workingDays.'+data['workingDays']) : ''">
    ...
    <div class="row q-pb-sm">
      ...
      <labelField :label="$t('backOrder.create.onCallRemarks')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" 
        valueClass="q-pl-md col-3 row" :value="selectedBo['onCallRemarks']" v-if="selectedBo['type'] == 'referral'">
        <q-input v-model="data['onCallRemarks']" outlined dense  :disable="loading"/>
      </labelField>
    </div>

    <div class="row q-pb-sm">
      <labelField :label="$t('backOrder.create.workingDays')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" v-if="selectedBo['type'] == 'dispatch'"
        valueClass="q-pl-md col-3 flex" :value="selectedBo['workingDays']? $t('backOrder.workingDays.'+data['workingDays']) : ''">
        <q-field v-model="data['workingDays']" borderless hide-bottom-space :rules="[creationRule]">
          <q-radio :disable="loading" :label="$t('backOrder.workingDays.shiftSystem')" 
          val="shiftSystem" v-model="data['workingDays']" />
          <q-radio :disable="loading" :label="$t('backOrder.workingDays.fixed')" 
      ...
      <labelField :label="$t('backOrder.create.welfare')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" 
        valueClass="q-pl-md col-3" :value="selectedBo['welfare']"  v-if="selectedBo['type'] == 'referral'">
    ...
    <div class="row q-pb-sm">
      ...
      <labelField :label="$t('backOrder.create.childcare')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center"
        valueClass="q-pl-md col-3" :value="selectedBo['tasks_childcare']" v-if="selectedBo['type'] == 'referral'">
    ...
    <div class="row q-pb-sm">
      ...
      <labelField :label="$t('backOrder.create.retirementAge')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center"   v-if="selectedBo['type'] == 'referral'" 
        valueClass="q-pl-md col-3 flex" :value="selectedBo['retirementAge_tasks']? `${selectedBo['retirementAge_tasks']} ${$t('common.age')}` :''">
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'dispatch'">
      <LabelField :label="$t('client.backOrder.businessContent')" :edit="edit" :value="selectedBo['businessContent']">
        <q-input dense outlined bg-color="white" v-model="data['businessContent']" :disable="loading" />
      </LabelField>
      <LabelField :label="$t('backOrder.availabilityOnCallSupport')" :edit="edit" :value="selectedBo['availabilityOnCallSupport']">
        <q-input dense outlined bg-color="white" v-model="data['availabilityOnCallSupport']" :disable="loading" />
      </LabelField>
    </div>
    
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'dispatch'">
      <labelField :label="$t('backOrder.create.pickDrop')" :edit="edit" :value="data['pickDrop']?$t('common.yesShort') : $t('common.noShort')"
        labelClass="q-pl-md col-3 text-right self-center"  valueClass="q-pl-md col-3 flex">
        <q-field
          borderless dense
          v-model="data['pickDrop']"
          :rules="[() => 'pickDrop' in data || '' ]" hide-bottom-space> 
      ...
      <labelField :label="$t('backOrder.create.onCallRemarks')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center" 
        valueClass="q-pl-md col-3 row" :value="selectedBo['onCallRemarks']" >
        <q-input v-model="data['onCallRemarks']" outlined dense  :disable="loading"/>
      </labelField>
    </div>
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'">
      ...
      <div class="col-6">
        <div class="row">
          <labelField :label="$t('backOrder.create.referralFee')" :edit="edit" labelClass="q-pl-md col-6 text-right self-center self-center" 
            valueClass="q-pl-md col-6 flex" :value="`${selectedBo['retirementAge']} %`">
        ...
        <div class="row">
          <labelField :label="$t('backOrder.create.referralFeeAmount')" :edit="edit" labelClass="q-pl-md col-6 text-right self-center" 
            valueClass="q-pl-md col-6 flex" :value="selectedBo['stipulatedAmount'] ? `${selectedBo['stipulatedAmount']} ${$t('common.yen')}` : ''">
    ...
    <div class="row q-pb-sm" v-if="selectedBo['type'] == 'referral'">
      ...
      <labelField :label="$t('client.list.memo')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center"  
        valueClass="q-pl-md col-3" :value="selectedBo['memo_house']">
    ...
    <div class="row q-pt-sm" v-if="selectedBo['type']=='referral'">
      <labelField :label="$t('backOrder.create.annualHolidays')" :edit="edit" labelClass="q-pl-md col-3 text-right self-center"  
        valueClass="q-pl-md col-3 flex" :value="selectedBo['annualHolidays'] ? `${data['annualHolidays']} ${$t('weekDay.sunday')}` : ''">
