  ...
  <q-card-section class="bg-white ">
    ...
    <div class="row q-pb-sm">
      ...
      :valueClass="'col-4 q-pl-md self-center flex no-wrap'" labelClass="q-pl-md col-2 text-right self-center"
        ...
        <span class="q-ma-sm flex-center text-no-wrap">{{ $t('backOrder.time') + ' ~' }}</span>
    ...
    <div class="row q-pb-sm">
      <LabelField :label="$t('backOrder.create.workingDays')" :edit="edit"
        labelClass="q-pl-md col-2 text-right self-center" valueClass="q-pl-md col-4 valueClass_flexyBoxy"
    ...
    <div class="row q-pb-sm">
      ...
      <LabelField :label="`${$t('office.workingHours')}  ${$t('office.nightShift')}`" :edit="edit"
        labelClass="q-pl-md col-2 text-right self-center" valueClass="q-pl-md col-4 flex no-wrap items-center"
