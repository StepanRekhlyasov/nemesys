<template>
  <q-tabs v-model="tab" dense class="bg-grey-3 text-primary new tabs" active-color="primary" indicator-color="primary"
    align="left" narrow-indicator inline-label switch-indicator active-bg-color="white">
