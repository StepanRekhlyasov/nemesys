    ...
    <q-form ref="form">
      <div class="row q-pb-sm">
        <labelField :label="$t('applicant.list.fixEmployment.status')" :edit="edit.includes('info')" 
          :value="fixData.fixStatus? 'OK' : 'NG' " valueClass="text-uppercase col-3 q-pl-md self-center" required>
        ...
        <labelField :label="$t('applicant.list.fixEmployment.date')" :edit="edit.includes('info')" 
          :value="fixData.fixDate" required valueClass="col-3 q-pl-md self-center" >
          <q-input v-if="edit.includes('info')" dense outlined bg-color="white" hide-bottom-space
            v-model="data['fixDate']" :disable="loading" :rules="[creationRule, validateDate]">
      ...
      <div class="row q-pb-sm">
        <labelField 
          ...
          <q-select
            ...
            :disable="loading" :rules="[creationRule]"
