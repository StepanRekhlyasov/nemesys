        ...
        <td>
          <table class="sub-table">
            <tr>
              ...
              <td>{{props.bo.workingDays?props.bo.workingDays.includes('monday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.tuesday')}}</th>
              <td>{{props.bo.workingDays? props.bo.workingDays.includes('tuesday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.wednesday')}}</th>
              <td>{{props.bo.workingDays?  props.bo.workingDays.includes('wednesday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.thursday')}}</th>
              <td>{{ props.bo.workingDays? props.bo.workingDays.includes('thursday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.friday')}}</th>
              <td>{{ props.bo.workingDays? props.bo.workingDays.includes('friday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.saturday')}}</th>
              <td>{{ props.bo.workingDays? props.bo.workingDays.includes('saturday')?'△':'×':'-' }}</td>
            </tr>
            <tr>
              <th>{{$t('weekDay.sunday')}}</th>
              <td>{{ props.bo.workingDays? props.bo.workingDays.includes('sunday')?'△':'×':'-' }}</td>
            </tr>
          </table>
        </td>
        <td>
