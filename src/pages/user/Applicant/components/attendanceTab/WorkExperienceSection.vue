<template>
  <DropDownEditGroup :bo="bo" :isEdit="edit" :label="'2.' + $t('applicant.attendant.workExperience')"
    ...
    <div class="row q-pb-sm">
      ...
      <div class="col-4 q-pl-md blue self-center">
        ...
        <q-input v-if="edit" dense outlined bg-color="white" type="number" v-model="data['totalYear']"
          :disable="loading" />
      </div>
    </div>
    <div>
