      ...
      <q-card class="no-shadow bg-grey-3">
            ...
            <div class="col-10">
              <div class="row">
                <div class="col-9 flex items-center">
                  ...
                  <div class="q-pl-md">
                    <q-select :options="statusOption" v-model="applicantStore.state.selectedApplicant.status"
        ...
        <q-card-section class="bg-white q-ma-md">
          ...
          <div class="row">
            ...
            <div class="col-5 row">
              <span class="col-6 text-right text-primary text-weight-regular">{{ $t('applicant.list.availableDays')
              }}</span>
