<template>
  <q-card class="no-shadow full-width q-ma-none">
    ...
    <q-table :columns="columns" :rows="historyData" row-key="name" v-model:pagination="pagination" hide-pagination class="q-pl-sm q-mr-xs" :loading="loading">
...
import { JobResult, TeleAppointmentHistory, TeleAppointmentResult, UserTele } from 'src/shared/model/TeleAppoint.model';
...
const teleData: TeleAppointmentHistory | JobResult | TeleAppointmentResult = ref({
  requiredService: [],
  result: '',
  jobResult: '',
  remark: '',
