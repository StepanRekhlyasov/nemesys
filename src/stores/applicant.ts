...
export const useApplicant = defineStore('applicant', () => {
  ...
  return { state, getClients, loadApplicantData, getApplicantsByColumns, countApplicantsByStatus, updateApplicant, createApplicant, createApplicantExclusive, getApplicantContactData, saveWorkExperience, countApplicantsByMedia, getApplicantsByConstraints, saveFixDataToApplicant, deleteApplicants, getApplicantById, toJSON, fromJSON }
})
