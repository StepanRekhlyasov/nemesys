...
import { collection, getFirestore, Timestamp, getDocs, collectionGroup, query, where } from 'firebase/firestore';
...
export const useAdvanceSearchAdmin = defineStore('advanceSearchAdmin', () => {
