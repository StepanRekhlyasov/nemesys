<template>
  ...
  <q-layout view="lHh Lpr lFf">
          ...
          <q-btn-dropdown unelevated flat color="white" label="Account">
            <q-list>
              <q-item class="bg-grey-3">
                ...
                <q-item-section>
                  <p class="q-pt-md">Logged in as <strong>{{ name }}</strong></p>
                </q-item-section>
              </q-item>
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above bordered style="background: #2A3F54;" :width="260">
      <q-list bordered padding class="rounded-borders text-white text-subtitle2">
        <q-item-label header>
