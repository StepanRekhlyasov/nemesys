        ...
        <div class="flex">
          ...
          <q-btn-dropdown
            ...
            <q-list>
              ...
              <q-item clickable :to="routeNames.admin" target="_blank" v-close-popup class="q-pt-none q-pb-none" v-if="isPermission(permissions, UserPermissionNames.AdminPageAccess)">
                <q-item-section>
                  <q-item-label>
